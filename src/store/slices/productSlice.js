...
function currentPageProducts(state) {
  ...
  if (filter.category.length) {
    ...
    console.log("newcurrentPageProducts", newcurrentPageProducts);
  } else {
  ...
  console.log("currentPageProducts", state.currentPageProducts);
  console.log("productsAfterFilterNSort", state.productsAfterFilterNSort);
  state.currentTab = 1;
}
...
export const productSlice = createSlice({
  ...
  reducers: {
    ...
    updateFilter: (state, action) => {
      console.log("inside for  updateFilter store", action.payload);
...
//         state.filter = {
//           ...state.filter,
//           category: action.payload.data.length ? action.payload.data : ["all"],
//         };
//         currentPageProducts(state);
//       } else if (action.payload.prop === "price") {
//         state.filter = { ...state.filter, price: action.payload.data };
